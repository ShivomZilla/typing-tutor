...
class Game:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.open_img = pygame.image.load('images/opn.png')
        ...
        pygame.display.set_caption('TypingTutor')
...
def run(self):
    ...
    while(self.running):
        ...
        self.draw_text(self.scren, self.input_text, 274, 26, (250, 250, 250))
    ...
    def reset_game(self):
        ...
        msg = "TypingTutor: Typing Speed Test"
